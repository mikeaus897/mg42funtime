...
void SV_Init( void ) {
	...
	// Nobo - global stats
	sv_globalStats = Cvar_Get("sv_globalStats", "0", CVAR_ARCHIVE);
#ifdef _DEBUG
	sv_globalStatsToken = Cvar_Get("sv_globalStatsToken", "", CVAR_ARCHIVE);
	sv_globalStatsServerName = Cvar_Get("sv_globalStatsServerName", "127.0.0.1", CVAR_ARCHIVE);
	sv_globalStatsServerPath = Cvar_Get("sv_globalStatsServerPath", "/submit_stats.php", CVAR_ARCHIVE);
	sv_globalStatsPort = Cvar_Get("sv_globalStatsPort", "80", CVAR_ARCHIVE);
#else
	sv_globalStatsToken = Cvar_Get("sv_globalStatsToken", "", CVAR_ARCHIVE);
	sv_globalStatsServerName = Cvar_Get("sv_globalStatsServerName", "", CVAR_ARCHIVE);
	sv_globalStatsServerPath = Cvar_Get("sv_globalStatsServerPath", "", CVAR_ARCHIVE);
	sv_globalStatsPort = Cvar_Get("sv_globalStatsPort", "", CVAR_ARCHIVE);
#endif

	// Nobo - external ip
	sv_getExternalIpDomain = Cvar_Get("sv_getExternalIpDomain", "api.ipify.org", CVAR_ARCHIVE);
	sv_getExternalIpServerIp = Cvar_Get("sv_getExternalIpServerIp", "", CVAR_LATCH);
	sv_ipExternal = Cvar_Get("sv_ipExternal", "", CVAR_LATCH);

	// Nobo - forced pk3 downloads
	sv_forcedPk3Downloads = Cvar_Get("sv_forcedPk3Downloads", "", CVAR_LATCH);
	...
	sv_master[0] = Cvar_Get( "sv_master1", "wolfmaster.idsoftware.com", 0 );      // L0 - custom master server
	sv_master[1] = Cvar_Get( "sv_master2", "wolfmaster.s4ndmod.com", CVAR_ARCHIVE );	// L0 - set this as default in case if s4ndmod lags out..
