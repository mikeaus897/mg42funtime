...
void Cmd_TinyAutomg42_f(gentity_t *ent)
{
	TryDroppingAutomg42(ent, 0.3f);
}
...
{
	TryDroppingAutomg42(ent, 2.0f);
}

void Cmd_MegaAutomg42_f(gentity_t *ent)
{
	TryDroppingAutomg42(ent, 4.0f);
}
...
void Cmd_DisplayServerCredit_f(gentity_t *ent) {
	...
	CP("print \"^3Based on: ^7github.com/nobowned/rtcwPub\n\"");
	CP("print \"^3Compile date: ^72022-jun-25 22:30 \n\"");
...
static const player_command_t playerCommands[] = {
	...
	{ "mega_automg42 mega", "Drops a meeeega automg42 on the ground. Must be an engineer, and g_automg42 > 0", "/mega", Cmd_MegaAutomg42_f, qfalse },
	{ "big_automg42 big", "Drops a biiiiiiig automg42 on the ground. Must be an engineer, and g_automg42 > 0", "/big", Cmd_BigAutomg42_f, qfalse },
	{ "micro_automg42 micro", "Drops a micro automg42 on the ground. Must be an engineer, and g_automg42 > 0", "/micro", Cmd_MicroAutomg42_f, qfalse },
	{ "tiny_automg42 tiny", "Drops a tiny automg42 on the ground. Must be an engineer, and g_automg42 > 0", "/tiny", Cmd_TinyAutomg42_f, qfalse },
	...
	{ "getstatus gs", "Displays information about each player in the server, such as name, ip, country location, status", "", Cmd_GetStatus_f, qtrue },
	{ "listplayers lp", "Displays information about each player in the server, such as name, ip, country location, status", "", Cmd_GetStatus_f, qtrue },
