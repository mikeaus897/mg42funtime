...
void Netchan_Setup( netsrc_t sock, netchan_t *chan, netadr_t adr, int qport_value );
...
#define UPDATE_SERVER_NAME      "update.idsoftware.com"
#define MASTER_SERVER_NAME      "wolfmaster.idsoftware.com"
#define AUTHORIZE_SERVER_NAME   "authorize.idsoftware.com"
...
typedef enum {
	...
	SE_STREAMED_PACKET // evPtr is a netadr_t followed by data bytes to evPtrLength
} sysEventType_t;
